...
# all installation
RUN yum update -y && yum install -y epel-release httpd mod_ssl mod_wsgi nano && yum -y --nogpgcheck localinstall https://github.com/pingidentity/mod_auth_openidc/releases/download/v1.8.8/mod_auth_openidc-1.8.8-1.el7.centos.x86_64.rpm && yum clean -y all
